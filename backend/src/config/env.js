...
export const env = {
  ...
  STELLAR_NETWORK: process.env.STELLAR_NETWORK || 'mainnet',
  STELLAR_HORIZON_URL: process.env.STELLAR_HORIZON_URL || 'https://horizon.stellar.org',
  STELLAR_SOROBAN_URL: process.env.STELLAR_SOROBAN_URL || 'https://soroban-rpc.stellar.org',
