...
const API = import.meta.env.VITE_API_URL || 'https://aletheia21-production.up.railway.app';
...
export default function Login({ isOpen, onClose, onLogin, currentWalletAddress }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch(`${API}/api/auth/login`, {
        ...
        body: JSON.stringify({ identifier, password, requested_role: activeTab, current_wallet_address: currentWalletAddress })
      });
