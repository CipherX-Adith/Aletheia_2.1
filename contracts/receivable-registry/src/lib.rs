// ============================================================
//  ReceivableRegistry â€” Aletheia
//  Manages the lifecycle of tokenized export receivables:
//  register â†’ attest (2-of-3) â†’ mint â†’ active â†’ settled
// ============================================================
#![no_std]
...
impl ReceivableRegistry {
    ...
    // â”€â”€ Exporter: Register a new receivable â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Attestors: Sign off on a receivable â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Internal: Mint receivable token â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn mint_receivable_token(_env: &Env, receivable: &mut Receivable) -> Symbol {
    ...
    // â”€â”€ State transitions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    /// Emergency clawback â€” issuer only.
...
mod tests {
    ...
    fn test_register_and_attest() {
        ...
        // First attestation â€” still pending
        client.attest(&att1, &id);
        let rec = client.get_receivable(&id);
        assert_eq!(rec.status, ReceivableStatus::Pending);

        // Second attestation â€” threshold met â†’ Attested
