...
// â”€â”€ Data Types â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
pub struct SaleListing {
    ...
    pub shares: Map<Address, i128>,    // investor â†’ amount purchased (cents)
...
#[contractimpl]
impl FractionalSale {
    // â”€â”€ Initializer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Exporter: List receivable for fractional sale â”€â”€â”€â”€â”€â”€â”€â”€

    /// Called by the exporter after their receivable has been attested.
    /// `discount_bps` â€” discount in basis points (100 bps = 1%).
    ///   A 500 bps discount on a $10,000 receivable means investors pay $9,500.
    /// `min_share_cents` â€” smallest tranche an investor can buy (e.g. $100 = 10000).
    /// `max_share_cents` â€” 0 means no upper limit per investor.
    pub fn list_for_sale(
        ...
        if discount_bps > 2000 {
            // Cap at 20% discount â€” sanity guard
    ...
    // â”€â”€ Investor: Buy a fractional share â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    /// Investor sends stablecoin proportional to their share.
    /// `amount_cents` â€” how much of the face value they want to buy.
    ...
    /// tokens â€” so KYC is enforced at the protocol layer automatically.
    pub fn buy_share(
        env: Env,
        investor: Address,
        receivable_id: u128,
    ...
    // â”€â”€ Exporter / Admin: Close sale and release funds â”€â”€â”€â”€â”€â”€â”€
...
mod tests {
    ...
    fn test_auto_close_on_full_subscription() {
        ...
        // Buy exactly the full face value â€” should auto-close
